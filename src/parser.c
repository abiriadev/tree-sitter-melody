...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_range] = STATE(58),
    [sym_symbol] = STATE(58),
    [sym__unicode_category] = STATE(59),
    [sym_negative_char_class] = STATE(58),
    [sym_variable] = STATE(58),
    [sym_group] = STATE(10),
    [sym_variable_declaration] = STATE(10),
    [sym_assertion] = STATE(10),
  ...
  [23] = {
    ...
    [aux_sym_literal_token2] = ACTIONS(137),
  ...
  [24] = {
    ...
    [anon_sym_LTcategory_COLON_COLONsurrogate_GT] = ACTIONS(21),
    [anon_sym_LTcategory_COLON_COLONunassigned_GT] = ACTIONS(21),
    [aux_sym_negative_char_class_token1] = ACTIONS(145),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [37] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(25),
  ...
  [49] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(24),
  [52] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(61),
  [55] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(60),
  [58] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(59),
  ...
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_quantifier, 5),
  [91] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_quantifier, 5),
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assertion, 2),
  [95] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_assertion, 2),
  [97] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group, 2),
  [99] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_group, 2),
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_quantifier, 6),
  [103] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_quantifier, 6),
  [105] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__atom, 2, .production_id = 2),
  [107] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__atom, 2, .production_id = 2),
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_quantifier, 3),
  [111] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_quantifier, 3),
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression, 1, .production_id = 1),
  [115] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression, 1, .production_id = 1),
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assertion, 3),
  [119] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_assertion, 3),
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 3, .production_id = 4),
  [123] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block, 3, .production_id = 4),
  [125] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_declaration, 4),
  [127] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variable_declaration, 4),
  [129] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group, 3),
  [131] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_group, 3),
  [133] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__atom, 3, .production_id = 3),
  [135] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__atom, 3, .production_id = 3),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_quantifier, 4),
  [139] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_quantifier, 4),
  ...
  [165] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_range, 3),
  [167] = {.entry = {.count = 1, .reusable = true}}, SHIFT(50),
  [169] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 2),
  ...
  [183] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_negative_char_class, 2),
  ...
  [201] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_range, 4),
