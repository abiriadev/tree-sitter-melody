...
enum ts_symbol_identifiers {
  ...
  aux_sym_range_token1 = 7,
  anon_sym_LTchar_GT = 8,
  anon_sym_LTspace_GT = 9,
  anon_sym_LTwhitespace_GT = 10,
  anon_sym_LTnewline_GT = 11,
  anon_sym_LTtab_GT = 12,
  anon_sym_LTreturn_GT = 13,
  anon_sym_LTfeed_GT = 14,
  anon_sym_LTnull_GT = 15,
  anon_sym_LTdigit_GT = 16,
  anon_sym_LTvertical_GT = 17,
  anon_sym_LTword_GT = 18,
  anon_sym_LTalphabetic_GT = 19,
  anon_sym_LTalphanumeric_GT = 20,
  anon_sym_LTboundary_GT = 21,
  anon_sym_LTbackspace_GT = 22,
  anon_sym_LTstart_GT = 23,
  anon_sym_LTend_GT = 24,
  anon_sym_LTcategory_COLON_COLONletter_GT = 25,
  anon_sym_LTcategory_COLON_COLONlowercase_letter_GT = 26,
  anon_sym_LTcategory_COLON_COLONuppercase_letter_GT = 27,
  anon_sym_LTcategory_COLON_COLONtitlecase_letter_GT = 28,
  anon_sym_LTcategory_COLON_COLONcased_letter_GT = 29,
  anon_sym_LTcategory_COLON_COLONmodifier_letter_GT = 30,
  anon_sym_LTcategory_COLON_COLONother_letter_GT = 31,
  anon_sym_LTcategory_COLON_COLONmark_GT = 32,
  anon_sym_LTcategory_COLON_COLONnon_spacing_mark_GT = 33,
  anon_sym_LTcategory_COLON_COLONspacing_combining_mark_GT = 34,
  anon_sym_LTcategory_COLON_COLONenclosing_mark_GT = 35,
  anon_sym_LTcategory_COLON_COLONseparator_GT = 36,
  anon_sym_LTcategory_COLON_COLONspace_separator_GT = 37,
  anon_sym_LTcategory_COLON_COLONline_separator_GT = 38,
  anon_sym_LTcategory_COLON_COLONparagraph_separator_GT = 39,
  anon_sym_LTcategory_COLON_COLONsymbol_GT = 40,
  anon_sym_LTcategory_COLON_COLONmath_symbol_GT = 41,
  anon_sym_LTcategory_COLON_COLONcurrency_symbol_GT = 42,
  anon_sym_LTcategory_COLON_COLONmodifier_symbol_GT = 43,
  anon_sym_LTcategory_COLON_COLONother_symbol_GT = 44,
  anon_sym_LTcategory_COLON_COLONnumber_GT = 45,
  anon_sym_LTcategory_COLON_COLONdecimal_digit_number_GT = 46,
  anon_sym_LTcategory_COLON_COLONletter_number_GT = 47,
  anon_sym_LTcategory_COLON_COLONother_number_GT = 48,
  anon_sym_LTcategory_COLON_COLONpunctuation_GT = 49,
  anon_sym_LTcategory_COLON_COLONdash_punctuation_GT = 50,
  anon_sym_LTcategory_COLON_COLONopen_punctuation_GT = 51,
  anon_sym_LTcategory_COLON_COLONclose_punctuation_GT = 52,
  anon_sym_LTcategory_COLON_COLONinitial_punctuation_GT = 53,
  anon_sym_LTcategory_COLON_COLONfinal_punctuation_GT = 54,
  anon_sym_LTcategory_COLON_COLONconnector_punctuation_GT = 55,
  anon_sym_LTcategory_COLON_COLONother_punctuation_GT = 56,
  anon_sym_LTcategory_COLON_COLONother_GT = 57,
  anon_sym_LTcategory_COLON_COLONcontrol_GT = 58,
  anon_sym_LTcategory_COLON_COLONformat_GT = 59,
  anon_sym_LTcategory_COLON_COLONprivate_use_GT = 60,
  anon_sym_LTcategory_COLON_COLONsurrogate_GT = 61,
  anon_sym_LTcategory_COLON_COLONunassigned_GT = 62,
  sym_raw = 63,
  anon_sym_DOT = 64,
  anon_sym_LBRACE = 65,
  anon_sym_RBRACE = 66,
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_amount] = ACTIONS(7),
    [anon_sym_not] = ACTIONS(9),
    [aux_sym_range_token1] = ACTIONS(11),
    [sym_comment] = ACTIONS(3),
  },
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [26] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_range, 3),
  [28] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_range, 3),
  [30] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_range, 4),
  [32] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_range, 4),
